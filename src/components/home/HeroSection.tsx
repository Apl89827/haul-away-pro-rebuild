...
const HeroSection = () => {
  return (
    <div className="relative w-full min-h-[90vh] flex items-center overflow-hidden bg-gray-900">
      ...
      {/* Gradient overlay */}
      <div className="absolute inset-0 bg-gradient-to-r from-brand-darkBlue/90 via-brand-blue/70 to-brand-darkBlue/80 z-10"></div>
        ...
        <div className="max-w-3xl animate-fade-in-up">
          ...
          <div className="flex flex-col sm:flex-row gap-4 animate-fade-in-up animation-delay-600">
            <Link to="/booking" className="group">
              <Button size="lg" className="bg-brand-green hover:bg-brand-green/90 text-white text-lg transform transition-all duration-300 hover:scale-105 hover:shadow-2xl shadow-brand-green/50">
      ...
      {/* Trust Bar */}
      <div className="absolute bottom-0 left-0 right-0 bg-white/95 backdrop-blur-md py-4 hidden md:block z-30">
        <div className="container-custom">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div className="flex flex-col items-center transform hover:scale-105 transition-transform duration-300">
              <span className="font-semibold text-lg text-brand-blue">15+</span>
