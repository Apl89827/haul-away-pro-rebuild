...
const HowItWorksCtaSection = () => {
  return (
    <section className="bg-gradient-to-r from-brand-blue to-brand-darkBlue py-20">
      <div className="container-custom">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a 
              href="tel:5137128077" 
              className="inline-flex items-center justify-center gap-2 bg-white text-brand-blue font-semibold py-4 px-8 rounded-md hover:bg-white/90 transition-colors text-lg"
            >
          ...
          <p className="text-white/70 text-sm mt-6">
            No obligation • Free estimates • Serving Greater Cincinnati since 2008
          </p>
        </div>
      </div>
    </section>
