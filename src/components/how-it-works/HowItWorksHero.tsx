        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link to="/booking">
                <Button className="btn-primary text-lg px-8 bg-green-600 hover:bg-green-500">Check Availability</Button>
              </Link>
          ...
          <div className="relative">
            <div className="bg-white rounded-lg shadow-lg p-6 text-center">
              <img src="/lovable-uploads/0f74e61c-3d29-4c7b-802b-413818b9735d.png" alt="HaulAway PRO professional junk removal truck - Same-day service in Greater Cincinnati" className="w-full h-80 object-contain rounded-lg mb-6 bg-gray-50" />
