      ...
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-200 bg-white ${isScrolled ? "shadow-md py-2" : "py-3"}`}>
        <div className="container-custom flex justify-between items-center">
          <Link to="/" className="flex items-center" onClick={closeMobileMenu}>
            <img src="/lovable-uploads/4e32cc5f-6030-4353-b20e-54e583de4c3d.png" alt="HaulAway Pro Logo" className="h-10 md:h-14" loading="eager" />
          </Link>
          ...
          {/* Mobile Menu Button */}
          <button className="md:hidden p-2 -mr-2" onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)} aria-label="Toggle menu">
        ...
        <>
          ...
          <div className="fixed top-0 right-0 h-full w-80 max-w-[85vw] bg-white z-50 md:hidden shadow-xl">
            ...
            <nav className="flex flex-col">
              ...
              <Link to="/contact" className="mobile-menu-item" onClick={closeMobileMenu}>
                Contact
              </Link>
            </nav>
          </div>
