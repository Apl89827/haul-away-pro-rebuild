...
const BookingGooglePage = () => {
  ...
  const handleBookingClick = () => {
    // Track Google campaign source
    console.log('Lead source: Google Campaign');
  ...
  const handlePhoneClick = () => {
    // Track Google phone lead
    console.log('Phone lead source: Google Campaign');
  };
...
export default BookingGooglePage;
